    ...
    <v-card flat hover>
        <v-card-text class="text-xs-center">
            <div style="display:flex; flex-direction: column">
                <div>
                    <img v-show="rbService.isActive && rbService.isMisting" src="/assets/mist-on.svg" height=200px/>
                    <img v-show="rbService.isActive && !rbService.isMisting" src="/assets/mist-off.svg" height=200px/>
        ...
        <v-card-text>Misting: {{rbService.isMisting}}</v-card-text>
